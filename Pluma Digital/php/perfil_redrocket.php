...
<head>
    ...
    <title>Perfil de RedRocket</title>
</head>
<body>
<div class="header">
    <div class="usuario">
...
<div class="container">
    <div class="informacionusuario">
        ...
        <ul class="informacionpersonal">
            <li><p>Nombre y Apellido: <?php echo htmlspecialchars($usuario['email']); ?></p></li>
            <li><p>Fecha de Creación: <?php echo htmlspecialchars($usuario['fecha_nacimiento']); ?></p></li>
        </ul>
    </div>
